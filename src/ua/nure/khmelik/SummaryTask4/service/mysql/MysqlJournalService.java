...
public class MysqlJournalService implements JournalService {
    ...
    @Override
    public int addCourseControlPoint(CourseControlPoint point) {
	// TODO Auto-generated method stub
	return 0;
    }

    @Override
    public int deleteCourseControlPoint(int idPoint) {
	// TODO Auto-generated method stub
	return 0;
    }

    @Override
    public int setAnotherDate(CourseControlPoint point) {
	// TODO Auto-generated method stub
	return 0;
    }
